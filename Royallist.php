...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Royal Bagan<span> Hotel</span></h1>
...
$data1=$db->query("select* from royal");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="Royallist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from royal where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='Royallist.php'</script>";
}
