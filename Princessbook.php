...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/Princess3.jpg" alt="" height="110" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span> Bagan Princess Hotel's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO princess VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='Princessbook.php'</script>";
       }
...
<link href="css/bookform.css" rel="stylesheet">
    ...
    body {  
         ...
         background-image: url("Bagan images/Princess1.jpg");
...
<body>
<form action="Princessbook.php" method="post">
   <h1>Book Here!</h1>
  ...
  <option value="Standard Triple">Standard Triple</option>
  <option value="Superior Twin">Superior Twin</option>
  <option value="Deluxe Twin">Deluxe Twin</option>
    <option value="Jasmine Garden View Villa">Jasmine Garden View Villa</option>
      <option value="Orchid Lake View Villa">Orchid Lake View Villa</option>
</select>
<br><br>
