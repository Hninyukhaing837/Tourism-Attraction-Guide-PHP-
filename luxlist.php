...
<div class="topnav" id="myTopnav">
    ...
    <!-- <img src="Bagan images/lux.jpg" alt="" height="120" width"100" style="float:left; position:relative;"/> -->
    <h1 >&nbsp; &nbsp; <span>Hotel Lux <span>Ngwesaung</span></h1>
...
$data1=$db->query("select* from lux");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="luxlist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from lux where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='luxlist.php'</script>";
}
