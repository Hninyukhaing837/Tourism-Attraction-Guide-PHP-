...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Hotel A1 Mandalay's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO a1 VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='A1book.php'</script>";
       }
...
<body>
<form action="A1book.php" method="post">
   <h1>Book Here!</h1>
