...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/garden2.jpg" alt="" height="110" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>Hill Garden Hotel Chaungtha's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO garden VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='gardenbook.php'</script>";
       }
...
<body>
<form action="gardenbook.php" method="post">
   <h1>Book Here!</h1>
  ...
  <option value="Bungalow Air Conditioning">Bungalow Air Conditioning</option>
  <option value="Standard Bungalow with Fan ">Standard Bungalow with Fan </option>
