...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/amazing1.jpg" alt="" height="135" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>Amazing Hotel's Details</span></h1>
  ...
  <h1 style="color: blue;">Remember to book your favourite room!</h1>
    <p style="color:black; text-align:left;"><b>Only 4 rooms left!</b><br>
     ...
     <i class="fa fa-wifi" aria-hidden="true"></i> Free Wifi Available!</p><hr>
        <p style="color:black; text-align: left; "> <i class="fa fa-map-marker" style="width:30px"></i>Ngapali beach, Rakhine state, Myanmar, 11121 Ngapali, Myanmar<br>
          <i class="fa fa-phone" style="width:30px"></i>+95-503256</p>
...
<div class="container">
  ...
  <div class="mySlides">
    <div class="numbertext">1 / 6</div>
      <img src="Bagan images/seaview.jpg" style="width:100%; height: 400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
      <img src="Bagan images/suite.jpg" style="width:100%; height:400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
      <img src="Bagan images/wing.jpg" style="width:100%; height: 400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
      <img src="Bagan images/A1dd.jpg" style="width:100%; height: 400px">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="Bagan images/seaview.jpg" style="width:100%; height:165px;" onclick="currentSlide(1)" alt="Sea View Deluxe Double Room">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/suite.jpg" style="width:100%; height:165px;" onclick="currentSlide(2)" alt="Beach Front Suite">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/wing.jpg" style="width:100%; height:165px;" onclick="currentSlide(3)" alt="Sea View Deluxe Double Room-New Wing">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/A1dd.jpg" style="width:100%; height:165px;" onclick="currentSlide(4)" alt="Deluxe Double">
    </div> 
     <div class="column">
...
$data1=$db->query("select* from amazingroom");
