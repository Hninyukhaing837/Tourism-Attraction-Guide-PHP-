...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Hotel A1's<span> Room Entry Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['add'])){
   ...
   $sql="INSERT INTO a1room VALUES ('$room','$facility','$choice','$price')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='a1room.php'</script>";
       }
...
<body>
<form action="a1room.php" method="post">
