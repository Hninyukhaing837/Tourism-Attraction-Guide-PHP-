...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Hotel A1's Details</span></h1>
  ...
  <h1 style="color: blue;">Remember to book your favourite room!</h1>
    <p style="color:black; text-align:left;"><b>Only 4 rooms left!</b><br>
     ...
     <i class="fa fa-wifi" aria-hidden="true"></i> Free Wifi Available!</p><hr>
        <p style="color:black; text-align: left; "> <i class="fa fa-map-marker" style="width:30px"></i>Corner of 32nd and 83rd Street, Chan Aye Tharzan Township, Mandalay, Myanmar  <br>
          <i class="fa fa-phone" style="width:30px"></i>+95-217575</p>
...
<div class="container">
  ...
  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
      <img src="Bagan images/A1sd.jpg" style="width:100%; height:400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
      <img src="Bagan images/A1st.jpg" style="width:100%; height: 400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
      <img src="Bagan images/A1dt.jpg" style="width:100%; height: 400px">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="Bagan images/A1sd.jpg" style="width:100%; height:165px;" onclick="currentSlide(1)" alt="Superior Double">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/A1st.jpg" style="width:100%; height:165px;" onclick="currentSlide(2)" alt="Superior Twin">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/A1dt.jpg" style="width:100%; height:165px;" onclick="currentSlide(3)" alt="Deluxe Twin">
    </div>
    <div class="column">
...
$data1=$db->query("select* from a1room");
