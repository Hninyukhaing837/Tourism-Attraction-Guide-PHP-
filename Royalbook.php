...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/royal2.jpg" alt="" height="110" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>Royal Bagan Hotel's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO royal VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='Royalbook.php'</script>";
       }
...
<link href="css/bookform.css" rel="stylesheet">
    ...
    body {  
         ...
         background-image: url("Bagan images/royal.jpg");
...
<body>
<form action="Royalbook.php" method="post">
   <h1>Book Here!</h1>
    <label for="">Username</label>
    <input type="text" class="form-control" name="username" value="" placeholder="Enter your name!" required><br>
    <label for="">Email</label>
    <input type="email" class="form-control" name="email" value="" placeholder="example@gmail.com"><br>
  ...
  <option value="Superior Double with Garden View" >Superior Double with Garden View</option>
  <option value="Family room">Family room</option>
  <option value="Grand Deluxe Double">Grand Deluxe Double</option>
  <option value="Superior Double">Superior Double</option>
    <option value="1 Person in 5-Bed Dormitory- Mixed- Spa">1 Person in 5-Bed Dormitory- Mixed- Spa</option>
      <option value="Superior Double or Twin - Guestroom">Superior Double or Twin - Guestroom</option>
</select>
<br><br>
