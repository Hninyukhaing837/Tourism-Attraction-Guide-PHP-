...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/mandalay2.jpg" alt="" height="120" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>The Home Hotel Mandalay's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO home VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='Homehotelbook.php'</script>";
       }
...
<link href="css/bookform.css" rel="stylesheet">
    ...
    body {  
         ...
         background-image: url("Bagan images/f16.jpg");
...
<body>
<form action="Homehotelbook.php" method="post">
   <h1>Book Here!</h1>
  ...
  <option value="Family-3 persons">Family-3 persons</option>
