...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Amazing Hotel's<span> Room Entry Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['add'])){
   ...
   $sql="INSERT INTO amazingroom VALUES ('$room','$facility','$choice','$price')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='amazingroom.php'</script>";
       }
...
<body>
<form action="amazingroom.php" method="post">
