...
<div class="topnav" id="myTopnav">
    ...
    <!-- <img src="Bagan images/amazing5.jpg" alt="" height="120" width"100" style="float:left; position:relative;"/> -->
    <h1 >&nbsp; &nbsp; <span>Amazing Ngapali <span>Resort</span></h1>
      <a href="adminhome.php"  class="active">Admin Home</a>
      <a href="adminteam.php"  class="active">Admin Team</a>
  ...
  <div class="dropdown">
   ...
   <ul style="float:right"><a class="active" href="login.php">Log Out</a></ul>
    ...
    body {  
         ...
         background-image: url("images/Bagan1.jpg");
...
$data1=$db->query("select* from amazing");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="amazinglist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from amazing where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='amazinglist.php'</script>";
}
