...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['add'])){
   ...
   $sql="INSERT INTO princessroom VALUES ('$room','$facility','$choice','$price')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='princessroom.php'</script>";
       }
...
<body>
<form action="princessroom.php" method="post">
