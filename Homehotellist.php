...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>The Home Hotel <span>Mandalay</span></h1>
...
$data1=$db->query("select* from home");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="Homehotellist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from home where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='Homehotellist.php'</script>";
}
