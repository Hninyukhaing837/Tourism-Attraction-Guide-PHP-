...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/Au1.jpg" alt="" height="110" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>Aureum Palace Hotel's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO aureum VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='Aureumbook.php'</script>";
       }
...
<link href="css/bookform.css" rel="stylesheet">
    ...
    body {  
         ...
         background-image: url("Bagan images/Aureum7.jpg");
...
<body>
<form action="Aureumbook.php" method="post">
   <h1>Book Here!</h1>
  ...
  <option value="lotus villa">Lotus Villa</option>
  <option value="Superior">Superior</option>
  <option value=" Jasmine or Orchid Garden View Villa"> Jasmine or Orchid Garden View Villa</option>
  <option value=" Jasmine or Orchid lake View Villa"> Jasmine or Orchid lake View Villa</option>
</select>
<br><br>
