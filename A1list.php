...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Hotel A1 <span>Mandalay</span></h1>
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="A1list.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from a1 where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='A1list.php'</script>";
}
