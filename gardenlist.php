...
<div class="topnav" id="myTopnav">
    ...
    <!-- <img src="Bagan images/garden1.jpg" alt="" height="120" width"100" style="float:left; position:relative;"/> -->
    <h1 >&nbsp; &nbsp; <span>Hill Garden Hotel <span>Chaungtha</span></h1>
    ...
    <a href="gardenroom.php">Add Hillgardenhotel's Room</a>
       ...
       <div class="dropdown">
    <button class="dropbtn">Beach Hotels's Rooms
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="Aureumlist.php">Add Amazinghotel's Room</a>
    <a href="Princesslist.php">Add Luxhotel's Room</a>
    <a href="Royallist.php">Add Hillgardenhotel's Room</a>
    </div>
  </div
  <div class="dropdown">
...
$data1=$db->query("select* from garden");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="gardenlist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from garden where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='gardenlist.php'</script>";
}
