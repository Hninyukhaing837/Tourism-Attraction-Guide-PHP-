...
<div class="topnav" id="myTopnav">
    ...
    <img src="Bagan images/amazing.jpg" alt="" height="110" width"100" style="float:left; position:relative;"/>
    <h1 >&nbsp; &nbsp; <span>Amazing Ngapali Resort's <span>Booking Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['book'])){
   ...
   $sql="INSERT INTO amazing VALUES ('$username','$phone','$email','$guest','$checkindate','$checkoutdate','$rooms')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='amazingbook.php'</script>";
       }
...
<link href="css/bookform.css" rel="stylesheet">
    ...
    body {  
         ...
         background-image: url("Bagan images/amazing2.jpg");
...
<body>
<form action="amazingbook.php" method="post">
   <h1>Book Here!</h1>
   ...
   <select name="rooms">
  <option value="Sea View Deluxe Double">Sea View Deluxe Double</option>
  <option value="Beach Front Suite">Beach Front Suite</option>
  <option value="Sea View-New Wing">Sea View-New Wing</option>
