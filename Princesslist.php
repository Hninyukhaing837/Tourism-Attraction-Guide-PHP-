...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Bagan Princess <span>Hotel</span></h1>
...
$data1=$db->query("select* from princess");
...
while ($row = mysqli_fetch_assoc($data1))
 {
    ...
    echo '<td><a href="Princesslist.php?username='.$row['username'].'">Delete</a></td>';

}

if(isset($_GET['username'])){
	$username=$_GET['username'];
	$sql="DELETE from princess where username ='$username'";
	$sql1=mysqli_query($db,$sql);
	echo"<script>alert('delete')</script>";
	echo"<script>window.location ='Princesslist.php'</script>";
}
