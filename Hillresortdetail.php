  ...
  <h1 style="color: blue;">Remember to book your favourite room!</h1>
    <p style="color:black; text-align:left;"><b>Only 4 rooms left!</b><br>
     ...
     <i class="fa fa-wifi" aria-hidden="true"></i> Free Wifi Available!</p><hr>
        <p style="color:black; text-align: left; "> <i class="fa fa-map-marker" style="width:30px"></i>No 9, 416B Kwin 10th Street, At The Foot Of Mandalay Hill, Northern Mandalay, Mandalay, Myanmar agoda<br>
          <i class="fa fa-phone" style="width:30px"></i>+95-78456678</p>
...
<div class="container">
  ...
  <div class="mySlides">
    <div class="numbertext">1 / 6</div>
      <img src="Bagan images/hillsup2.jpg" style="width:100%; height: 400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
      <img src="Bagan images/Hillsupk.jpg" style="width:100%; height:400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
      <img src="Bagan images/Hilldek.jpg" style="width:100%; height: 400px">
  </div>

  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
      <img src="Bagan images/Hilldes.jpg" style="width:100%; height: 400px">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="Bagan images/hillsup2.jpg" style="width:100%" onclick="currentSlide(1)" alt="Superior 2 Single Beds">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/Hillsupk.jpg" style="width:100%" onclick="currentSlide(2)" alt="Superior King Bed Room">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/Hilldek.jpg" style="width:100%; height:165px;" onclick="currentSlide(3)" alt="Delux King Bed Room">
    </div>
    <div class="column">
      <img class="demo cursor" src="Bagan images/Hilldes.jpg" style="width:100%; height:165px;" onclick="currentSlide(4)" alt="Delux 2 Single Beds">
    </div> 
     <div class="column">
...
$data1=$db->query("select* from mercureroom");
