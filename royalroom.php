...
<div class="topnav" id="myTopnav">
    ...
    <h1 >&nbsp; &nbsp; <span>Royal Baganhotel's <span>Room Entry Page</span></h1>
...
mysqli_select_db($con,"thesis");
 ...
 if(isset($_POST['add'])){
   ...
   $sql="INSERT INTO royalroom VALUES ('$room','$facility','$choice','$price')";
    $sql1=mysqli_query($con,$sql);
      ...
      if ($count>0) 
      {
        ...
        echo "<script>window.location='royalroom.php'</script>";
       }
...
<body>
<form action="royalroom.php" method="post">
